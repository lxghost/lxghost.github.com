...
![The default Docsy shell](/images/docsy.webp)
...
**Example 2-2.** Bringing up a new replica with pg\_basebackup\.
...
See [Figure 2-2](#fig-2-2) and [Example 2-1](#eg-2-1);
with an explicit anchor: [Figure 2-1](#book-release-note).
...
- [Code Blocks](/docs/components/code/)
