...
本地搜索默认关闭；打开后命令面板才会出现（顶栏放大镜、Cmd\/Ctrl + K、`/`、`\`）。
...
- [Oink v0.8.0](/zh/blog/release/0.8.0/)
- [文档](/zh/docs/)
...
- [代码块](/zh/docs/components/code/)
- [Draw.io](/zh/docs/components/drawio/)
- [参数表](/zh/docs/components/fields/)
- [图片](/zh/docs/components/image/)
- [引用](/zh/docs/components/include/)
- [思维导图](/zh/docs/components/markmap/)
- [公式](/zh/docs/components/math/)
- [Mermaid](/zh/docs/components/mermaid/)
- [PlantUML](/zh/docs/components/plantuml/)
...
- [配置 Schema](/zh/docs/design/decisions/config-schema/)
- [配置模型](/zh/docs/design/decisions/configuration/)
