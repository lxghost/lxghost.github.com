...
- 侧栏是你自己的目录树，每页都能打开
- 按 Ctrl + K（macOS 上是 ⌘ + K）打开命令面板，能搜到刚写的页面
...
- [仓库导览](/zh/docs/start/anatomy/): 克隆下来的每个目录是什么：哪些必须保留、哪些替换为你的信息、哪些是文档站自用可以整个删除。
- [从零建站与其它安装方式](/zh/docs/start/from-scratch/): 从空目录搭一个最小 OINK 站点，以及 Module / submodule / 离线归档 / 克隆四种安装方式的取舍。

---

反链：

- [跑起第一个站点](/zh/book/01-start/)
- [文档](/zh/docs/)
- [简介](/zh/docs/about/)
