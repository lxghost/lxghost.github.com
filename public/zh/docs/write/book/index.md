...
> 用 `type: book` 把一棵目录树变成一本书：章节编号、图表式例编号、交叉引用、生成式索引与整本打印。
...
![Docsy 主题的默认外壳](/images/docsy.webp)
...
**示例 2-2.** 用 pg\_basebackup 拉起一个新从库。
...
参见 [图 2-2](#fig-2-2) 与 [示例 2-1](#eg-2-1)；
显式锚点：[图 2-1](#book-release-note)。
